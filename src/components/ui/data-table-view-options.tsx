...
export function DataTableViewOptions({
  ...
  return (
    <Popover>
      <PopoverTrigger
        className={cn(
          'h-9 text-xs font-semibold text-slate-700 bg-white hover:bg-slate-50 border border-slate-300 shadow-2xs gap-2 px-3 rounded-lg flex items-center select-none cursor-pointer transition-colors',
          buttonClassName
        )}
      >
